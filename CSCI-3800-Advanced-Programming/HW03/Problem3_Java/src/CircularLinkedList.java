...
Class definition and implementation for a generic circular singly linked list (CircularLinkedList).
CircularLinkedList utilizes the generic Node class to hold data of anytype, signified by 'T'.
...
public class CircularLinkedList<T> {
    ...
    public Node<T> lastPtr; // points to the last element in the linked list
    ...
    // data of type 'T' can be any data value, int, char, string, etc
